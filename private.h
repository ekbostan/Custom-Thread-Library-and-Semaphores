 ...
 *
 * This type is an opaque data structure type that contains a thread's executio\
n
 ...
 * @preempt: Enable preemption if true   * Configure a timer that must fire a virtual alarm at a frequency of 100 Hz an\
d
